...
{
    public class NativeRfcPreparedFunction : RfcPreparedFunction
    {
        ...
        public override RfcPreparedFunction Prepare()
        {
            ...
            {
                if (ex.GetBaseException() is RqRfcException)
                    throw ex;

                throw new RqRfcCallException(ex.Message, function == null ? this.FunctionName : function.ToString(), ex);
            }
        }
        ...
        public override RfcResult Execute()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new RqRfcCallException(ex.Message, function == null ? "null" : function.ToString(), ex);
            }

            return new NativeRfcResult(function, this.structureMapper);
        }
